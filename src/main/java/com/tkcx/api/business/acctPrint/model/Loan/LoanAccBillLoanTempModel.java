...
@Getter
@Setter
@TableName(value="LOAN_ACC_BILL_TEMP",schema="QN_DB_LOAN")
public class LoanAccBillLoanTempModel extends Model<LoanAccBillLoanTempModel> implements IAcctPrintCommon {
