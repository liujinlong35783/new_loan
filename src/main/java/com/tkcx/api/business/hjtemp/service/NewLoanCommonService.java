...
public class NewLoanCommonService {
     ...
     * @return
     */
    public Map<String, String> excuteFiles(Date acctDate) {
        Date startDate = new Date();
        log.info("NewLoanCommonService excuteFiles ..." + startDate);
        String produceFilePath = new SimpleDateFormat("yyyyMMdd").format(acctDate);
...
//            hjFileInfoModel.setFileId();
            ...
            int startIndex = file1.getName().indexOf("_") + 1;
            int endIndex = file1.getName().lastIndexOf("_");
            String fileType = file1.getName().substring(startIndex, endIndex);
