 ...
 */
@Repository
public interface XinLoanAcctDetailTempDao extends BaseMapper<XinLoanAcctDetailTempModel>{
     ...
     * @return
     */
    Integer selectModelCount(@Param("e")XinLoanAcctDetailTempModel model);

    Integer selectCountNotInEleAccount(@Param("e")XinLoanAcctDetailTempModel model);
     ...
     * @return
     */
    List<XinLoanAcctDetailTempModel> selectModelList(@Param("e")XinLoanAcctDetailTempModel model);
    /**
     * 根据交易流水查科目
     * @param channelSeq
     * @param debtFlag
    ...
    XinLoanAcctDetailTempModel getDetailBySeq(@Param("channelSeq")String channelSeq, @Param("debtFlag")String debtFlag);
