...
public class NewLoanFileFlagConstant {
     ...
     * 网贷借款借据回单文件每行长度
     */
    public final static int JJHD_LINE_LENGTH = 18;
     ...
     * 网贷还款回单文件每行长度
     */
    public final static int HKHD_LINE_LENGTH = 23;
     ...
     * 网贷业务机构业务流水文件每行长度
     */
    public final static int YWLS_LINE_LENGTH = 16;
     ...
     * 贷款明细账文件每行长度
     */
    public final static int MXZ_LINE_LENGTH = 19;
     ...
     * 贷款利息登记簿文件每行长度
     */
    public final static int LXDJB_LINE_LENGTH = 22;
     ...
     * 会计凭证文件每行长度
     */
    public final static int KJPZ_LINE_LENGTH = 22;
